...
const CourseModal = ({course,courseModel,setCourseModel}) => {
      ...
      return ( 
        ...
        className="fixed insta-border rounded-b-2xl w-[100vw] h-[100vh] ml-[100px]"
      >
        ...
        <div className="mainContent flex flex-col px-14 py-10 h-fit ">
          {/* PAGES GO HERE */}
          {home_page && <span className="h-[500px] p-10">schedules</span>}
          {anouncements && <span className="h-[500px] p-10">anouncements</span>}
          {messages && <span className="h-[500px] p-10">messages</span>}

          {discussion_board && <span className="h-[500px] p-10">discussion board</span>}
        </div>
  {/* 
